  ...
  return (
    <div className="px-6 space-y-8">
      <div className="space-y-1">
        ...
        <p className="text-on-surface-variant text-sm font-medium">File complaints and track their status</p>
      </div>
      ...
      <div className="relative bg-gradient-to-br from-[#064E3B] to-[#10B981] rounded-2xl p-8 text-white shadow-xl overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 text-center">
          ...
          <div>
            ...
            <h3 className="font-headline text-xl font-black">Complaint Center</h3>
            <p className="text-white/70 text-sm mt-2">
              Submit issues, track resolution progress, and rate service quality.
            </p>
          </div>
        </div>
      </div>
      ...
      {[
        { icon: 'report',              label: 'File a Complaint',    desc: 'Report issues to your syndic' },
        { icon: 'manage_search',       label: 'Track Status',        desc: 'Follow up on open complaints' },
        { icon: 'star_rate',           label: 'Rate Service',        desc: 'Leave feedback on resolved issues' },
      ].map((f) => (
