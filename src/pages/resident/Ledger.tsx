  ...
  return (
    <div className="px-6 space-y-8">
      <div className="space-y-1">
        <h2 className="font-headline text-2xl font-black text-primary tracking-tight">Payment Ledger</h2>
        <p className="text-on-surface-variant text-sm font-medium">Your charges and payment history</p>
      </div>
      ...
      <div className="relative bg-gradient-to-br from-[#064E3B] to-[#10B981] rounded-2xl p-8 text-white shadow-xl overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 text-center">
          ...
          <div>
            ...
            <h3 className="font-headline text-xl font-black">Payment History</h3>
            <p className="text-white/70 text-sm mt-2">
              Track all charges, payments, and download receipts.
            </p>
          </div>
        </div>
      </div>
      ...
      {[
        { icon: 'receipt_long',        label: 'Charge History',   desc: 'Monthly charges from your syndic' },
        { icon: 'check_circle',        label: 'Payment Records',  desc: 'Confirmed and pending payments' },
        { icon: 'download',            label: 'Receipts',         desc: 'Download PDF payment receipts' },
      ].map((f) => (
