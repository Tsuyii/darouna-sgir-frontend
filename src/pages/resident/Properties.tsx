  ...
  return (
    <div className="px-6 space-y-8">
      <div className="space-y-1">
        ...
        <p className="text-on-surface-variant text-sm font-medium">Your apartment details and documents</p>
      </div>
      ...
      <div className="relative bg-gradient-to-br from-[#064E3B] to-[#10B981] rounded-2xl p-8 text-white shadow-xl overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 text-center">
          ...
          <div>
            ...
            <h3 className="font-headline text-xl font-black">Property Details</h3>
            <p className="text-white/70 text-sm mt-2">
              View your apartment info, floor plan, and important documents.
            </p>
          </div>
        </div>
      </div>
      ...
      {[
        { icon: 'home',         label: 'Apartment Info',   desc: 'Floor, unit number, surface area' },
        { icon: 'key',          label: 'Access Codes',     desc: 'Building entry and parking codes' },
        { icon: 'description',  label: 'Documents',        desc: 'Lease, insurance, and certificates' },
      ].map((f) => (
