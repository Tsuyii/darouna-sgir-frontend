  ...
  return (
    <div className="px-6 space-y-8">
      <div className="space-y-1">
        <h2 className="font-headline text-2xl font-black text-primary tracking-tight">Financial Control</h2>
        <p className="text-on-surface-variant text-sm font-medium">Charges, payments and financial reports</p>
      </div>
      ...
      <div className="relative bg-gradient-to-br from-[#064E3B] to-[#10B981] rounded-2xl p-8 text-white shadow-xl overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 text-center">
          ...
          <div>
            ...
            <h3 className="font-headline text-xl font-black">Finance Module</h3>
            <p className="text-white/70 text-sm mt-2">
              Issue charges, confirm payments, and generate financial reports.
            </p>
          </div>
        </div>
      </div>
      ...
      {[
        { icon: 'request_quote', label: 'Issue Charges',    desc: 'Create monthly charges for residents' },
        { icon: 'receipt_long',  label: 'Payment History',  desc: 'Track all incoming and pending payments' },
        { icon: 'summarize',     label: 'Reports',          desc: 'Export financial summaries and statements' },
      ].map((f) => (
