  ...
  return (
    <div className="px-6 space-y-8">
      <div className="space-y-1">
        <h2 className="font-headline text-2xl font-black text-primary tracking-tight">Task Approval</h2>
        <p className="text-on-surface-variant text-sm font-medium">Review and approve maintenance tasks</p>
      </div>
      ...
      <div className="relative bg-gradient-to-br from-[#064E3B] to-[#10B981] rounded-2xl p-8 text-white shadow-xl overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 text-center">
          ...
          <div>
            ...
            <h3 className="font-headline text-xl font-black">Task Management</h3>
            <p className="text-white/70 text-sm mt-2">
              Create tasks, assign gardiens, and approve completed maintenance work.
            </p>
          </div>
        </div>
      </div>
      ...
      {[
        { icon: 'add_task',       label: 'Create Tasks',    desc: 'Assign maintenance work to gardiens' },
        { icon: 'how_to_reg',     label: 'Approve Work',    desc: 'Review submitted tasks with evidence' },
        { icon: 'query_stats',    label: 'Task Analytics',  desc: 'Track completion rates and response times' },
      ].map((f) => (
